...
import {
  HiArrowRight, HiLocationMarker, HiPlus,
  HiPencil, HiTrash, HiCheck, HiHome,
} from "react-icons/hi";
...
function AddressFormModal({
  ...
  const inp = "w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition bg-white";
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">{addresses.length} آدرس ذخیره شده</p>
            </div>
          </div>
          <button
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl p-12 text-center shadow-sm">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">هنوز آدرسی ندارید</h3>
            <p className="text-sm text-gray-500 mb-6">آدرس‌های تحویل خود را ذخیره کنید</p>
            <button
              onClick={() => { setEditingAddress(null); setModalOpen(true); }}
              ...
              <div key={addr.id}
                ...
                <div className="flex items-start gap-3">
                  <div className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5 ${
                    ...
                    <HiHome className={`w-4 h-4 ${addr.is_default ? "text-blue-600" : "text-gray-400"}`} />
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed mb-2">{addr.address}</p>
                ...
                <div className="flex items-center gap-2 mt-4 pt-3 border-t border-gray-100">
                  {!addr.is_default && (
                    <button
                      ...
                      {settingDefaultId === addr.id ? "در حال تنظیم..." : "پیش‌فرض کن"}
                    </button>
                  )}
                  <button
