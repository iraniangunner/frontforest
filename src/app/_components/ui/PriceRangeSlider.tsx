      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <p
              className={`text-xs font-semibold ${isFiltered && lo > 0 ? "text-teal-700" : "text-gray-700"}`}
            >
              {fmt(toValue(lo))} ت
            </p>
          </div>
          ...
          >
            ...
            <p
              className={`text-xs font-semibold ${isFiltered && hi < 100 ? "text-teal-700" : "text-gray-700"}`}
            >
              {fmt(toValue(hi))} ت
            </p>
          </div>
