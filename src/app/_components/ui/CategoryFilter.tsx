  ...
  return (
    ...
    >
      ...
      <div className={isMobile ? "flex-1 overflow-y-auto" : ""}>
        ...
        {/* دسته‌بندی — flat، فقط siblings (children parent فعلی) */}
        {siblings.length > 0 && (
          <div className="border-b border-gray-100">
            <SecHead
              id="categories"
                ...
                {siblings.map((sib) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex items-center justify-between w-full py-2 px-1 rounded-lg hover:bg-gray-50 transition-colors group"
                    >
                      <div className="flex items-center gap-2">
                        <span
