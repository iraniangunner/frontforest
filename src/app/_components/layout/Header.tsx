                  ...
                  <div className="absolute left-0 mt-2 w-52 bg-white rounded-xl shadow-lg border py-2 z-50">
                    ...
                    <div className="border-t mt-2 pt-2">
                      <button
                        ...
                        className="flex items-center gap-3 px-4 py-2 w-full text-red-600 hover:bg-red-50"
                      >
        ...
        <div className="md:hidden border-t bg-white px-4 py-3 space-y-2">
          ...
          {user && (
            <>
              ...
              <button
                onClick={handleLogout}
                className="block w-full text-right px-4 py-2 text-red-600 hover:bg-red-50 rounded-lg"
              >
                خروج
              </button>
            </>
