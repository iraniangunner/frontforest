...
// شماره کارت — اینجا تغییر بده
const CARD_NUMBER = "6063-7312-8960-3962";
const CARD_OWNER = "فهیمه صادیقی";
// const SHEBA = "IR89 0600 7816 7000 5726 1440 01";
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm">
            <h2 className="font-semibold text-gray-900 flex items-center gap-2 mb-4">
              <HiShoppingCart className="w-5 h-5 text-teal-500" />
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm">
            <h2 className="font-semibold text-gray-900 flex items-center gap-2 mb-4">
              <HiCreditCard className="w-5 h-5 text-teal-500" />
              روش پرداخت
            </h2>
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm">
            <h2 className="font-semibold text-gray-900 flex items-center gap-2 mb-4">
              <HiTag className="w-5 h-5 text-teal-500" />
              کد تخفیف
            </h2>
