...
function parseParams(
  ...
  if (catList.length > 0) p.categories = Array.from(new Set(catList));
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]" dir="rtl">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
        ...
        {/* preserveOnClear=["q"] تا «پاک‌کردن همه» عبارت جستجو را حفظ کند */}
        <FilterProvider preserveOnClear={["q"]}>
          ...
          <FilterDrawer>
            <SearchFilter priceRange={priceRange} menu={menu} isMobile />
          </FilterDrawer>
        </FilterProvider>
      </div>
    </div>
